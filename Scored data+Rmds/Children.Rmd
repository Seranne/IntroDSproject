...
```{r}
chld <- read.csv("F://IntroDSproject/WDI data split/Children.csv")
...
childwelfare <- mutate(childwelfare, country.score = as.numeric(as.factor(rank(((rank.neet+rank.imr)/2)))))
View(childwelfare)
