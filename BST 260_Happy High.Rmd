...
>>>>>>> 814f5a038c0eb4e15b1fa96e42e30796a57ab6e1
...
tourism_score <- tour %>% mutate(finalrank_tourism = rank(-(tour$ST.INT.DPRT/tour$SP.POP.TOTL))) %>% select("CountryName", "finalscore_security")
...
```
As other variables have been Covered in previous categories, only inequality adjusted well-being indicator was selected for our score.
...
colnames(hpi_data_2016)[2] <- "CountryName"
 ...
 hpi_data_2016$finalrank_hpi <- as.numeric(as.factor(hpi_data_20162$finalrank_hpi2))
...
write.csv(final_score, file = "Happy Highs Well-Being Index")
````
