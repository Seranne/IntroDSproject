...
colnames(hpi_data_2016)[2] <- "CountryName"
 ...
 hpi_data_2016 <- hpi_data_2016 %>% mutate(finalrank_hpi = rank(-hpi_data_2016$`Inequality-adjusted_Wellbeing`))
 hpi_data_2016$finalrank_hpi<- as.numeric(as.factor(hpi_data_2016$finalrank_hpi))
 
hpi_data_2016<- select(hpi_data_2016,"CountryName",  "finalrank_hpi2")
