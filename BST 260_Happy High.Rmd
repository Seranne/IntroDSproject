...
colnames(Energy_score)[2] <- "Composite_Energy_Rank"
 Energy_score %>%
...
colnames(escore)[2] <- "Composite_Emissions_Rank"
 escore %>%
...
colnames(environment_score)[2] <- "Composite_Environment_Rank"
 environment_score %>%
...
colnames(Communication_score)[2] <- "Composite_Communications_Rank"
 Communication_score %>%
...
colnames(childwelfare_score)[2] <- "Composite_ChildWelfare_Rank"
 childwelfare_score %>%
...
colnames(deficit_score)[2] <- "Composite_Deficit_Rank"
 deficit_score %>%
...
colnames(economy_score)[2] <- "Composite_Economic_Rank"
es <- economy_score %>%
...
colnames(Education_score)[2] <- "Composite_Education_Rank"
 Education_score %>%
...
colnames(Gender_score)[2] <- "Composite_Gender_Rank"
 Gender_score %>%
...
colnames(employment_score)[2] <- "Composite_Employment_Rank"
 employment_score %>%
...
colnames(Population_score)[2] <- "Composite_Population_Rank"
Population_score %>% 
...
colnames(security_score)[2] <- "Composite_Security_Rank"
 security_score %>%
...
colnames(tourism_score)[2] <- "Composite_Tourism_Rank"
 tourism_score %>%
...
colnames(diversity)[2] <- "Composite_Diversity_Rank"
...
colnames(pos_affect)[2] <- "Positive_Affect_Rank" 
pos_affect %>%
...
colnames(neg_affect)[2] <- "Negative_Affect_Rank" 
neg_affect %>%
...
colnames(happyplanet_score)[2] <- "InequalityAdjusted_WellBeing_Rank"
happyplanet_score %>%
...
final score <- final score %>% select("CountryName", "region","sub.region","ourindex", "finalindex")
